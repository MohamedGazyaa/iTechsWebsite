// Partner logos shown in the reusable PartnersSection component.
// `logo` paths are under /public; `name` is the (untranslated) brand name used
...
export const partners = [
  ...
  { name: 'KINN',                logo: '/assets/partners/kinnLogo.png' },
  { name: 'Miyah',               logo: '/assets/partners/miyah.png' },
];
